          ...
          <div className="divide-y divide-border/50">
            {rows.map((o) => {
              ...
              return (
                <div
                  key={o.id}
                  className="relative p-4 sm:p-5 hover:bg-slate-50/70 transition-colors group"
                >
                  {/* Mobile: stacked layout / Desktop: flex row */}
                  <div
                    className="flex sm:flex-nowrap items-center gap-3 sm:gap-4 cursor-pointer"
                  ...
                  >
                    ...
                    {/* Application count — desktop only */}
                  ...
                  {/* Action buttons — always visible, separate row on mobile */}
                  <div className="flex items-center gap-1 mt-2 sm:mt-0 sm:absolute sm:right-5 sm:top-1/2 sm:-translate-y-1/2">
                    {o.statut !== "publiee" && canPublish && (
                      ...
                      >
                        ...
                        <span className="sm:hidden ml-1 text-xs font-semibold">Publier</span>
                      </Button>
                    )}
                    {o.statut === "publiee" && (
                      <Button
                      ...
                      >
                        ...
                        <span className="sm:hidden ml-1 text-xs font-semibold">Suspendre</span>
                      </Button>
                    )}
                    <Button
                      size="sm"
                    ...
                    >
                      ...
                      <span className="sm:hidden ml-1 text-xs font-semibold">Éditer</span>
                    </Button>
                    <Button
                      size="sm"
                      variant="ghost"
                    ...
                    >
                      ...
                      <span className="sm:hidden ml-1 text-xs font-semibold">Supprimer</span>
                    </Button>
                  </div>
                </div>
              );
