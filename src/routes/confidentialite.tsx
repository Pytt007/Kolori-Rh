  ...
  return (
    <div className="min-h-screen flex flex-col bg-background">
      ...
      <main className="flex-1 max-w-3xl mx-auto px-6 py-16 w-full">
        <div className="text-xs font-mono uppercase tracking-widest text-muted-foreground mb-3">Données personnelles</div>
        ...
        <div className="prose prose-stone max-w-none space-y-6 text-sm">
          <section>
            ...
            <p>Lors de votre inscription, nous collectons : nom, prénom, adresse email, et selon votre profil, votre CV, vos expériences et compétences (candidats), ou les informations de votre entreprise (recruteurs).</p>
          </section>
          <section>
            <h2 className="font-display italic text-2xl mb-2">Finalité</h2>
            <p>Ces données sont utilisées pour la mise en relation entre candidats et recruteurs, et pour le bon fonctionnement de la plateforme.</p>
          </section>
          <section>
            <h2 className="font-display italic text-2xl mb-2">Vos droits</h2>
            <p>Conformément au RGPD, vous disposez d'un droit d'accès, de rectification, d'opposition et de suppression de vos données. Adressez votre demande à privacy@lalternative-rh.example.</p>
          </section>
          <section>
