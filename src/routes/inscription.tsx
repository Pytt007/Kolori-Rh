...
function InscriptionPage() {
  ...
  const handleSubmit = async (e: FormEvent) => {
    ...
    toast.success("Compte créé.", { description: "Vérifiez votre email pour confirmer votre adresse." });
  ...
  return (
    ...
    >
      ...
      <p className="text-[11px] text-muted-foreground mt-5 leading-relaxed">
        ...
        <Link to="/mentions-legales" className="underline hover:text-primary">conditions d'utilisation</Link>{" "}
        et notre{" "}
