  ...
  head: () => ({
    meta: [
      { title: "À propos — Kolori RH" },
      {
        name: "description",
        content:
          "Découvrez l'histoire, la mission et les valeurs de Kolori RH, la plateforme de recrutement et de solutions RH de référence.",
      },
    ],
  }),
      ...
      <main className="flex-1">
        ...
        <section className="bg-primary text-primary-foreground border-b border-border/10 py-24 px-6 relative overflow-hidden">
          ...
          <div className="max-w-4xl mx-auto text-center animate-reveal relative z-10">
            <div className="text-xs font-mono uppercase tracking-widest text-white/70 font-bold mb-4">
              Notre Manifeste
            </div>
            ...
            <p className="text-white/80 text-lg max-w-2xl mx-auto leading-relaxed">
              Kolori RH est né d'une conviction simple : le recrutement ne doit pas être un
              algorithme froid, mais un processus transparent, humain et rigoureusement structuré.
            </p>
          </div>
        </section>
          ...
          <div className="grid md:grid-cols-2 gap-12 items-center">
            <div className="space-y-6 animate-reveal [animation-delay:100ms]">
              <h2 className="font-display font-bold text-3xl">
                Pourquoi <span className="text-primary">Kolori RH</span> ?
              </h2>
              <p className="text-muted-foreground text-sm leading-relaxed">
                Dans un marché du travail en constante mutation, trouver la bonne adéquation entre
                un projet de vie et les ambitions d'une entreprise est un défi. Les plateformes
                traditionnelles privilégient la quantité à la qualité, noyant les recruteurs sous
                des flux de CV non qualifiés et laissant les candidats dans l'incertitude.
              </p>
              <p className="text-muted-foreground text-sm leading-relaxed">
                Nous proposons une approche structurée où chaque entreprise est validée
                manuellement, chaque offre est modérée, et chaque étape du recrutement est claire et
                tracée. C'est cela, Kolori RH.
              </p>
            </div>
              ...
              {[
                {
                  icon: ShieldCheck,
                  title: "Rigueur",
                  desc: "Modération stricte de chaque offre d'emploi.",
                },
                {
                  icon: Award,
                  title: "Qualité",
                  desc: "Des entreprises partenaires de confiance.",
                },
                {
                  icon: Building2,
                  title: "Transparence",
                  desc: "Suivi en temps réel de chaque candidature.",
                },
        ...
        <section className="bg-muted/30 border-y border-border py-16 px-6">
          <div className="max-w-3xl mx-auto text-center space-y-6">
            ...
            <p className="text-muted-foreground text-sm max-w-lg mx-auto">
              Que vous cherchiez votre prochain emploi ou que vous souhaitiez recruter les meilleurs
